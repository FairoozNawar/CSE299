...
<!-- Navbar Starts -->
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
	 <div class="container">
	  <a class="navbar-brand" href="index.php">Fonimonosha</a>
	  ...
	  <div class="collapse navbar-collapse " id="navbarSupportedContent">
	    <ul class="ml-auto navbar-nav">
	      ...
	      <li class="nav-item dropdown">
	        ...
	        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
	          <a class="dropdown-item nav-color" href="selected.php?category=<?php echo "Vegetable"; ?>">Vegetable</a>
	          <a class="dropdown-item nav-color" href="selected.php?category=<?php echo "Decorative"; ?>">Decorative</a>
	          <a class="dropdown-item nav-color" href="selected.php?category=<?php echo "Water Jar"; ?>">Water Jar</a>
	          <a class="dropdown-item nav-color" href="selected.php?category=<?php echo "Organic"; ?>">Organic</a>
	          <div class="dropdown-divider"></div>
	          <a class="dropdown-item nav-color" href="all.php">All</a>
	        </div>
	      </li>
