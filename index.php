  ...
  ?>
	...
	<div class="container">
		<div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
		  <div class="carousel-inner">
		    <div class="carousel-item active">
		      <img style="width:1200px; height:600px;" src="images/ss2.jpg">
		      <div class="carousel-caption d-none d-md-block">
		        <h5>Plant Collection</h5>
		        <p>Find your dream Plants</p>
		      </div>
		    </div>
		    <div class="carousel-item ">
          <img style="width:1200px; height:600px;" src="images/ss1.jpg">
		      <div class="carousel-caption d-none d-md-block">
		        <h5>Plant Collection</h5>
		        <p>We offer the best Plants</p>
		      </div>
		    </div>
		    <div class="carousel-item">
          <img style="width:1200px; height:600px;" src="images/ss3.jpg">
		      <div class="carousel-caption d-none d-md-block">
		        <h5>Premium Instrument</h5>
		        <p>We offer the best Instrument</p>
		      </div>
		    </div>
        <div class="carousel-item">
          <img style="width:1200px; height:600px;" src="images/ss4.jpg">
		      <div class="carousel-caption d-none d-md-block">
		        <h5>Plants Components</h5>
		        <p>We provide Plants Components for your creative needs</p>
		      </div>
		    </div>
		  </div>
	  ...
	  <div class="container panjabi">
	  	 <div class="row">
        <?php 
          $sql = "SELECT * FROM `product` WHERE category='Decorative'  OR category='Vegetable' OR category='Water Jar' ORDER BY rand() ";
	  ...
	  <section class="contact">
	  	<div class="container-fluid">
	  		<div class="container">
	  			<div class="row">
	  				<div class="col-sm">
	  					<h3>Fonimonosha BD</h3><br><br>
	  					<p>Uttara, Dhaka</p>
	  					<p>016000000000</p>
	  					<p>Email : fonimonosha@gmail.com</p>
	  				</div>
	  ...
	  <footer>
	  	<p>© All rights reserved by Fonimonosha   |   Designed, Developed & Maintained by <a href="#" target="_blank">Fairooz Nawar Adnin</a></p>
	  </footer>
